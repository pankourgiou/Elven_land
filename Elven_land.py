...
pygame.display.set_caption("Elven Land")
...
background = pygame.image.load("elven_land.png")  # Make sure you have an image file
...
locations = [
    {"name": "A", "event": "The treasure is close keep going", "x": 100, "y": 200},
    {"name": "B", "event": "there are too many dangers around the place!!be careful!!!", "x": 200, "y": 300},
    {"name": "C", "event": "Do elves exist?", "x": 300, "y": 450},
    {"name": "D", "event": "It's about the journey not the destination", "x": 200, "y": 500},
]
...
def game_loop():
    ...
    while running:
        ...
        draw_text("Elven land - EXPLORE", 50, 50, NEON_BLUE)
